...
PROJECT_DIR="/home/rb/AI/gemma-routing"
...
start_router_api() {
  stop_pidfile_process "${API_PID_FILE}" "gemma-routing api"
  ...
  echo "Starting gemma-routing api on port ${API_PORT} (${api_pid})"
