...
DEFAULT_PROFILE = ROOT_DIR / "rag-answerer/config/korean_medical_device_rag.env"
DEFAULT_INPUT_DIR = (
    ROOT_DIR / "rag-answerer/test-corpus/mfds-korean-medical-device/starter"
)
DEFAULT_OUTPUT_DIR = (
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Chunk PDFs and build dense embeddings for rag-answerer."
    )
    parser.add_argument(
        "--input-dir",
        type=Path,
