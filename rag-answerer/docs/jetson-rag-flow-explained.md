...
이 문서는 `rag-answerer`가 실제로 어떤 흐름으로 동작하는지, 그리고 어려운 용어를 최대한 쉬운 말로 풀어서 설명한 문서다.
...
`rag-answerer`는 문서를 직접 찾는 프로그램이 아니라, 위쪽 검색기에서 찾아준 문서 조각을 받아서 최종 답변을 만드는 "답변 생성기"다.
...
- 테스트 문서: [`test-corpus/mfds-korean-medical-device/starter`](/home/rb/AI/rag-answerer/test-corpus/mfds-korean-medical-device/starter)
- 임베딩 모델: `mykor/KURE-v1`
- 생성 모델 alias: `gemma4-rag`
- 기본 생성 프로젝트: [`rag-answerer`](/home/rb/AI/rag-answerer)
- 임베딩/청크 생성 스크립트: [`scripts/build_embedding_index.py`](/home/rb/AI/rag-answerer/scripts/build_embedding_index.py)
- 평가 스크립트: [`scripts/evaluate_rag_answers.py`](/home/rb/AI/rag-answerer/scripts/evaluate_rag_answers.py)
- 평가 런처: [`launch-eval.sh`](/home/rb/AI/rag-answerer/launch-eval.sh)
...
- 문서 2개
- 총 청크 9개
- 결과 위치: [`indexes/mfds-korean-medical-device-starter-kure-v1`](/home/rb/AI/rag-answerer/indexes)
...
- [`embeddings.npy`](/home/rb/AI/rag-answerer/indexes/mfds-korean-medical-device-starter-kure-v1/embeddings.npy)
- [`chunks.jsonl`](/home/rb/AI/rag-answerer/indexes/mfds-korean-medical-device-starter-kure-v1/chunks.jsonl)
- [`manifest.json`](/home/rb/AI/rag-answerer/indexes/mfds-korean-medical-device-starter-kure-v1/manifest.json)
...
`rag-answerer`의 시스템 프롬프트는 아래 파일에 있다.

- [`prompts/rag_answer_system_prompt.txt`](/home/rb/AI/rag-answerer/prompts/rag_answer_system_prompt.txt)
...
- [`launch-eval.sh`](/home/rb/AI/rag-answerer/launch-eval.sh)
...
```bash
/home/rb/AI/.venv-rag-answerer-index/bin/python \
  /home/rb/AI/rag-answerer/scripts/build_embedding_index.py \
...
```bash
/home/rb/AI/rag-answerer/launch.sh status
```

### 3. 평가 실행

```bash
/home/rb/AI/rag-answerer/launch-eval.sh run
```
...
- `rag-answerer`를 이용해 실제 RAG 답변 평가를 돌릴 수 있다
...
- 프로젝트 개요: [`README.md`](/home/rb/AI/rag-answerer/README.md)
- RAG 프로필: [`config/korean_medical_device_rag.env`](/home/rb/AI/rag-answerer/config/korean_medical_device_rag.env)
- 인덱싱 가이드: [`docs/indexing-starter-corpus.md`](/home/rb/AI/rag-answerer/docs/indexing-starter-corpus.md)
- 평가 런처: [`launch-eval.sh`](/home/rb/AI/rag-answerer/launch-eval.sh)
- 평가 스크립트: [`scripts/evaluate_rag_answers.py`](/home/rb/AI/rag-answerer/scripts/evaluate_rag_answers.py)
