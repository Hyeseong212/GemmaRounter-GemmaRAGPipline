...
LLAMA_REST_PARALLEL="${LLAMA_REST_PARALLEL:-1}"
LLAMA_REST_N_CTX="${LLAMA_REST_N_CTX:-8192}"
LLAMA_REST_N_UBATCH="${LLAMA_REST_N_UBATCH:-512}"
LLAMA_REST_BATCH_CAPACITY="${LLAMA_REST_BATCH_CAPACITY:-${LLAMA_REST_N_CTX}}"
...
start_service() {
  ...
  setsid env \
    ...
    LLAMA_REST_PARALLEL="${LLAMA_REST_PARALLEL}" \
    LLAMA_REST_N_CTX="${LLAMA_REST_N_CTX}" \
    LLAMA_REST_N_UBATCH="${LLAMA_REST_N_UBATCH}" \
    LLAMA_REST_BATCH_CAPACITY="${LLAMA_REST_BATCH_CAPACITY}" \
