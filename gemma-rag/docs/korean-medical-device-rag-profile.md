...
This document describes the upstream retrieval profile that should feed [`gemma4-rag`](/home/rb/AI/gemma-rag/README.md).

`gemma-rag` is still the grounded answer generator.
...
- profile env: [`config/korean_medical_device_rag.env`](/home/rb/AI/gemma-rag/config/korean_medical_device_rag.env)
- generator prompt: [`prompts/rag_answer_system_prompt.txt`](/home/rb/AI/gemma-rag/prompts/rag_answer_system_prompt.txt)
