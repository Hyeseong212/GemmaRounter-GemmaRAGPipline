...
This is a small public Korean test corpus for early `gemma-rag` experiments.
...
- [`starter`](/home/rb/AI/gemma-rag/test-corpus/mfds-korean-medical-device/starter)
  - first-pass set with PDFs that already contain extractable text
- [`raw`](/home/rb/AI/gemma-rag/test-corpus/mfds-korean-medical-device/raw)
  - all downloaded source files
- [`extracted`](/home/rb/AI/gemma-rag/test-corpus/mfds-korean-medical-device/extracted)
  - files unpacked from the oxygen-device ZIP
- [`text`](/home/rb/AI/gemma-rag/test-corpus/mfds-korean-medical-device/text)
  - quick `pdftotext` outputs for inspection
- [`questions/smoke_test_questions.jsonl`](/home/rb/AI/gemma-rag/test-corpus/mfds-korean-medical-device/questions/smoke_test_questions.jsonl)
  - starter evaluation questions
- [`sources.tsv`](/home/rb/AI/gemma-rag/test-corpus/mfds-korean-medical-device/sources.tsv)
  - source metadata and download links

## What To Start With

Start by indexing the PDFs in [`starter`](/home/rb/AI/gemma-rag/test-corpus/mfds-korean-medical-device/starter).
...
1. Index only the PDFs in [`starter`](/home/rb/AI/gemma-rag/test-corpus/mfds-korean-medical-device/starter).
2. Ask the questions in [`questions/smoke_test_questions.jsonl`](/home/rb/AI/gemma-rag/test-corpus/mfds-korean-medical-device/questions/smoke_test_questions.jsonl).
3. Check:
