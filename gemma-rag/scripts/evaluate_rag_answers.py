...
DEFAULT_QUESTION_FILE = (
    ROOT_DIR
    / "gemma-rag/test-corpus/mfds-korean-medical-device/questions/smoke_test_questions.jsonl"
)
DEFAULT_PROMPT_FILE = ROOT_DIR / "gemma-rag/prompts/rag_answer_system_prompt.txt"
DEFAULT_OUTPUT_DIR = ROOT_DIR / "gemma-rag/test-results"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate gemma-rag QA against a starter corpus.")
...
def write_report_md(path: Path, report: dict[str, Any]) -> None:
    lines: list[str] = []
    lines.append("# gemma-rag Starter Evaluation")
    lines.append("")
